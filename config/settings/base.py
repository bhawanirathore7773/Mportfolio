...
should be hard-coded here — use decouple.config() with sane defaults.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="manish_portfolio"),
...
# ---------------------------------------------------------------------------
# Email — used for Contact / Hire Me notifications. All values come from the
# environment so no credentials are ever committed. See .env.example.
# ---------------------------------------------------------------------------
...
# File upload limits (also enforced in forms) — see apps/core/validators.py
